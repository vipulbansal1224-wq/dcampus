      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-white shadow-lg rounded-xl overflow-hidden">
          ...
          <div className="p-12 space-y-12 text-center">
            <div>
              <h2 className="text-2xl font-bold text-secondary mb-4">Thought of the Day</h2>
              <p className="text-xl text-slate-700 italic border-l-4 border-secondary pl-6 py-2 bg-slate-50">
            ...
            <div>
              <h2 className="text-2xl font-bold text-secondary mb-4">Word of the Day</h2>
              <div className="inline-block bg-primary text-white px-8 py-4 rounded-lg text-2xl font-bold tracking-widest">
                DAWN
              </div>
