    ...
    <div className="max-w-4xl mx-auto px-4 py-24 min-h-[70vh]">
      <div className="bg-white shadow-xl rounded-2xl overflow-hidden border border-slate-100">
        ...
        <div className="p-12 text-center flex flex-col items-center">
          <div className="w-64 h-64 relative rounded-lg overflow-hidden border-4 border-secondary shadow-md mb-8">
            <Image src="/Mr-Vaibhav.jpeg" alt="Mr. Vaibhav" fill className="object-cover" />
          </div>
          <h2 className="text-4xl font-bold text-primary mb-4">Mr. Vaibhav</h2>
