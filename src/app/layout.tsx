    ...
    >
      <body className="min-h-full flex flex-col bg-white text-slate-800 font-sans">
        <ThemeProvider>
          ...
          <div className="w-full bg-primary text-white py-2 text-sm">
          ...
          <nav className="w-full bg-white shadow-sm sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-24">
              ...
              <div className="hidden lg:flex items-center gap-6 text-[15px] font-semibold text-slate-700">
                ...
                <Link href="/certificate_verification" className="hover:text-secondary transition-colors">Certificate Verification</Link>
                <Link href="/events" className="hover:text-secondary transition-colors">Events</Link>
                <div className="relative group">
                  <Link href="/todays-special" className="hover:text-secondary transition-colors pb-4">
                    Today's Special
                  </Link>
                  <div className="absolute top-full left-0 mt-0 w-56 bg-white shadow-lg border border-slate-100 rounded opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 flex flex-col pt-2 pb-2">
                    <Link href="/birthdays" className="px-4 py-2 hover:bg-slate-50 hover:text-secondary transition-colors text-sm font-medium">Birthday's</Link>
                    <Link href="/student-of-the-week" className="px-4 py-2 hover:bg-slate-50 hover:text-secondary transition-colors text-sm font-medium">Student of the Week</Link>
                  </div>
                </div>
          ...
          {/* Footer */}
          <footer className="bg-primary text-slate-300 py-16 mt-auto">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
              ...
              <div className="md:col-span-1">
                ...
                <div className="flex gap-4">
                  <Link href="https://www.facebook.com/rahul.ketan?mibextid=ZbWKwL" target="_blank" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary transition-colors text-white" aria-label="Facebook">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" /></svg>
                  </Link>
                  <Link href="https://www.instagram.com/dcc_gopal/" target="_blank" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary transition-colors text-white" aria-label="Instagram">
              ...
              <div className="md:col-span-1">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li><Link href="/courses" className="hover:text-secondary transition-colors">Courses</Link></li>
              ...
              <div className="md:col-span-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-secondary mb-2">Contact Info</h4>
