  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-24 min-h-[70vh]">
      <div className="bg-white shadow-xl rounded-2xl overflow-hidden border border-slate-100">
        <div className="bg-gradient-to-r from-secondary to-orange-400 p-8 text-center text-white">
        ...
        <div className="p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              <div className="w-48 h-48 relative rounded-full overflow-hidden border-4 border-primary shadow-lg mb-6">
                <Image src="/Gopal-Ji-Director.jpeg" alt="Gopal Kumar G" fill className="object-cover" />
              </div>
              <h2 className="text-4xl font-bold text-primary mb-2">Gopal Kumar G</h2>
