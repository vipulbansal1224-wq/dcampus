    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">Welcome To Dawn Computer Campus</h1>
          <h2 className="text-xl text-secondary font-semibold mb-8">An ISO 9001:2015 Certified Organization &amp; Registered under Ministry of MSME, Govt. of India.</h2>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-primary mb-16">Our Facilities</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="text-center p-6 bg-slate-50 rounded-2xl hover:shadow-lg transition-all border border-slate-100">
              ...
              <h3 className="text-xl font-bold text-primary mb-3">Career Development Courses</h3>
            ...
            <div className="text-center p-6 bg-slate-50 rounded-2xl hover:shadow-lg transition-all border border-slate-100">
              ...
              <h3 className="text-xl font-bold text-primary mb-3">Online Certificate Verification</h3>
            ...
            <div className="text-center p-6 bg-slate-50 rounded-2xl hover:shadow-lg transition-all border border-slate-100">
              ...
              <h3 className="text-xl font-bold text-primary mb-3">Specialist Faculty</h3>
            ...
            <div className="text-center p-6 bg-slate-50 rounded-2xl hover:shadow-lg transition-all border border-slate-100">
              ...
              <h3 className="text-xl font-bold text-primary mb-3">1:1 Computer Ratio for students</h3>
            ...
            <div className="text-center p-6 bg-slate-50 rounded-2xl hover:shadow-lg transition-all border border-slate-100">
              ...
              <h3 className="text-xl font-bold text-primary mb-3">24x7 CCTV Monitoring</h3>
            ...
            <div className="text-center p-6 bg-slate-50 rounded-2xl hover:shadow-lg transition-all border border-slate-100">
              ...
              <h3 className="text-xl font-bold text-primary mb-3">Smart Class with Smart Devices</h3>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16 text-secondary">Administration</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            
            <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm text-center flex flex-col items-center">
              <div className="w-40 h-40 relative rounded-full overflow-hidden border-4 border-secondary mb-6 shadow-xl">
              ...
              <p className="text-secondary font-semibold mb-6">-- Director --</p>
            ...
            <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm text-center flex flex-col items-center">
              ...
              <p className="text-secondary font-semibold mb-6">-- Chairman --</p>
              <p className="text-slate-300 text-sm leading-relaxed">
            ...
            <div className="bg-white/10 p-8 rounded-2xl backdrop-blur-sm text-center flex flex-col items-center">
              ...
              <p className="text-secondary font-semibold mb-6">-- Managing Director --</p>
              <p className="text-slate-300 text-sm leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="flex flex-col items-center justify-center group">
              ...
              <h3 className="text-lg font-bold text-primary uppercase">Course</h3>
            </div>
            <div className="flex flex-col items-center justify-center group">
              <div className="w-20 h-20 relative mb-4 group-hover:-translate-y-2 transition-transform">
                <Image src="/Capture10.png" alt="Faculties" fill className="object-contain" />
              </div>
              <p className="text-3xl font-bold text-secondary mb-2">10+</p>
              <h3 className="text-lg font-bold text-primary uppercase">Faculties</h3>
            </div>
            <div className="flex flex-col items-center justify-center group">
              <div className="w-20 h-20 relative mb-4 group-hover:-translate-y-2 transition-transform">
                <Image src="/Capture12.png" alt="Students" fill className="object-contain" />
              </div>
              <p className="text-3xl font-bold text-secondary mb-2">1500+</p>
              <h3 className="text-lg font-bold text-primary uppercase">Students</h3>
            </div>
            <div className="flex flex-col items-center justify-center group">
              <div className="w-20 h-20 relative mb-4 group-hover:-translate-y-2 transition-transform">
              ...
              <h3 className="text-lg font-bold text-primary uppercase">Branches</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-primary mb-16">Teacher's &amp; Staff Views</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100 flex flex-col items-center text-center hover:shadow-xl transition-shadow relative">
                <div className="text-4xl text-secondary opacity-20 absolute top-4 left-4">"</div>
                <div className="w-24 h-24 relative rounded-full overflow-hidden border-2 border-primary mb-6">
                  <Image src={`/${t.img}`} alt={t.name} fill className="object-cover" />
                </div>
                <p className="text-slate-600 text-sm italic mb-6 leading-relaxed flex-grow">"{t.desc}"</p>
                <h4 className="font-bold text-primary border-t-2 border-secondary pt-4 w-1/2 mx-auto">{t.name}</h4>
              </div>
            ))}
          </div>
        </div>
