  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 space-y-16">
        ...
        {/* Director's Desk */}
        <div className="bg-white p-8 md:p-12 shadow rounded-lg border-t-4 border-secondary">
          <h2 className="text-3xl font-bold text-primary mb-6">Message from Director Desk</h2>
          <p className="text-slate-700 leading-relaxed text-lg italic bg-slate-50 p-6 rounded-r-lg border-l-4 border-primary">
        ...
        <div className="bg-white p-8 md:p-12 shadow rounded-lg">
          <h2 className="text-3xl font-bold text-primary mb-8 text-center uppercase tracking-widest">Courses Offered</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-slate-200 shadow-sm rounded-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow text-center">
                <h3 className="text-xl font-bold text-primary mb-4 uppercase">Short Term Courses</h3>
                ...
                <button onClick={() => toggleCourse('short')} className="mt-auto bg-secondary text-white px-6 py-2 rounded-full font-bold hover:bg-orange-600 transition-colors mx-auto">
            ...
            <div className="bg-white border border-slate-200 shadow-sm rounded-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow text-center">
                <h3 className="text-xl font-bold text-primary mb-4 uppercase">Long Term Courses</h3>
                {expandedCourse === 'long' && (
                  <div className="text-slate-600 text-sm mb-4 text-left">
                ...
                <button onClick={() => toggleCourse('long')} className="mt-auto bg-secondary text-white px-6 py-2 rounded-full font-bold hover:bg-orange-600 transition-colors mx-auto">
            ...
            <div className="bg-white border border-slate-200 shadow-sm rounded-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow text-center">
                <h3 className="text-xl font-bold text-primary mb-4 uppercase">Basic Computer Applications</h3>
                ...
                <button onClick={() => toggleCourse('basic')} className="mt-auto bg-secondary text-white px-6 py-2 rounded-full font-bold hover:bg-orange-600 transition-colors mx-auto">
            ...
            <div className="bg-white border border-slate-200 shadow-sm rounded-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow text-center">
                <h3 className="text-xl font-bold text-primary mb-4 uppercase">Web Developments</h3>
                {expandedCourse === 'web' && (
                  <ul className="list-disc list-inside space-y-1 text-slate-600 text-sm mb-4 text-left">
                ...
                <button onClick={() => toggleCourse('web')} className="mt-auto bg-secondary text-white px-6 py-2 rounded-full font-bold hover:bg-orange-600 transition-colors mx-auto">
            ...
            <div className="bg-white border border-slate-200 shadow-sm rounded-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow text-center">
                <h3 className="text-xl font-bold text-primary mb-4 uppercase">Programming Languages</h3>
                {expandedCourse === 'prog' && (
                ...
                <button onClick={() => toggleCourse('prog')} className="mt-auto bg-secondary text-white px-6 py-2 rounded-full font-bold hover:bg-orange-600 transition-colors mx-auto">
            ...
            <div className="bg-white border border-slate-200 shadow-sm rounded-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow text-center">
                <h3 className="text-xl font-bold text-primary mb-4 uppercase">Tally (Accounts)</h3>
                ...
                <button onClick={() => toggleCourse('tally')} className="mt-auto bg-secondary text-white px-6 py-2 rounded-full font-bold hover:bg-orange-600 transition-colors mx-auto">
            ...
            <div className="bg-slate-800 text-white border border-slate-700 shadow-sm rounded-lg overflow-hidden flex flex-col lg:col-span-3">
              <div className="p-8 flex flex-col items-center justify-center text-center">
                <h3 className="text-2xl font-bold text-secondary mb-4 uppercase">What is Time Management</h3>
                ...
                <a href="/DCC-time-management-1.pdf" target="_blank" rel="noopener noreferrer" className="bg-primary border border-secondary text-secondary px-8 py-3 rounded-full font-bold hover:bg-secondary hover:text-white transition-colors inline-block">
                  Click Here
                </a>
              </div>
            </div>
        ...
        <div className="bg-white p-8 md:p-12 shadow rounded-lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <section>
              <h2 className="text-2xl font-bold text-secondary mb-4">What is the basic qualification needed to be a computer literate?</h2>
              ...
              <h2 className="text-2xl font-bold text-secondary mb-4 mt-8">Coaching Scheme</h2>
            ...
            <section className="bg-slate-50 p-6 rounded-lg">
              <h2 className="text-2xl font-bold text-primary mb-4">Why to Join DCC ?</h2>
